...
interface TestGenerationStrategy {
    ...
    enum class Tags {
        DUMMY, PER_METHOD, PER_FILE, WITH_PROJECT_TREE, IMPORT_SPECIFICATION, MANUAL, JSON_RESPONSE
    }
...
data class TestGenerationStrategyBasicContainer(
    private val name: String,
    private val description: String,
    private val tags: List<TestGenerationStrategy.Tags>
    ...
    override fun deserialize(decoder: Decoder): TestGenerationStrategy {
        return decoder.decodeStructure(descriptor) {
            ...
            TestGenerationStrategyBasicContainer(
                ...
                tags = tagsstr!!.map { x -> enumValues<TestGenerationStrategy.Tags>().firstOrNull { it.name == x }!! }
                    .toList()
            )
        }
    }

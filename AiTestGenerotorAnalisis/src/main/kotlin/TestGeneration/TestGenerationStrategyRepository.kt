...
import org.filomilo.AiTestGenerotorAnalisis.TestGeneration.Strategies.JsonResponsePerFileStrategy
...
//            """.trimIndent(), listOf(
//                TestGenerationStrategy.Tags.PER_FILE,
//                TestGenerationStrategy.Tags.WITH_PROJECT_TREE,
//                TestGenerationStrategy.Tags.IMPORT_SPECIFICATION
//            )
//        ),
//        PromptPerFileStrategy(
//            """
...
//        ),
        ...
        JsonResponsePerFileStrategy(
            ...
            """.trimIndent(), listOf(
                TestGenerationStrategy.Tags.PER_FILE,
                TestGenerationStrategy.Tags.WITH_PROJECT_TREE,
                TestGenerationStrategy.Tags.JSON_RESPONSE
            )
        )
    )
}